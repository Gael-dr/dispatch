...
import { CalendarDaysIcon, Link2Icon, MailIcon, MessageSquareIcon, XIcon, BellIcon } from 'lucide-react'
                ...
                <div className="rounded-3xl border border-white/10 bg-slate-900/35 backdrop-blur-xl shadow-2xl overflow-hidden">
                    <div className="px-5 pt-5 pb-4 border-b border-white/10 flex items-center justify-between gap-3">
                        <div className="min-w-0">
                            <p className="text-white font-extrabold tracking-tight truncate">Configuration</p>
                    ...
                    <div className="px-5 py-4">
                        <p className="text-slate-400 text-xs font-bold tracking-wide mb-2">CONNECTEURS</p>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-white font-bold text-sm tracking-tight">{connector.label}</p>
                                            <p className="text-slate-400 text-xs font-medium">{connector.description}</p>
                                        </div>
