// src/features/calendar/ActionMessageModal.tsx
import { useEffect, useMemo, useState } from 'react'
import { useUIStore } from '@/app/store/uiStore'
import type { CalendarPayload } from '@/engine/cards/card.payloads'
import type { TemplateBuilder, Tone } from '@/features/calendar/actionMessageTemplates'
...
export function ActionMessageModal({ builder, onConfirm }: Props) {
    ...
    const toneBtn = (t: Tone, label: string, IconCmp: any) => {
        const active = tone === t
        return (
            <button
                type="button"
