...
export function ActionMessageModal({ builder, onConfirm }: Props) {
  ...
  return (
    ...
    >
      <DialogContent className="max-w-[420px] gap-4 border-white/10 bg-slate-900 p-0 shadow-2xl rounded-3xl">
        <DialogHeader className="flex flex-row items-start justify-between px-5 pt-5 pb-4 border-b border-white/10 text-left">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <DialogTitle className="text-white font-extrabold tracking-tight leading-none">
                {templates.title}
              </DialogTitle>
